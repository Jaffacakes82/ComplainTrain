...
namespace ComplainTrain.Core.Classes.SOAP
{
            ...
            if (this.SoapEnvelope.Body.GetDepBoardWithDetailsResponse.GetStationBoardResult.TrainServices != null) 
            {
                ...
                this.SoapEnvelope.Body.GetDepBoardWithDetailsResponse.GetStationBoardResult.TrainServices.Service.Select(
                    service => new Departure
                    {
                        ...
                        DestinationCode = service.Destination.Location.Crs,
                        Due = service.Std,
                        Expected = service.Etd,
                        Platform = service.Platform,
                        Operator = service.Operator,
                        OperatorCode = service.OperatorCode,
                        TrainLength = service.Length,
    ...
    [XmlRoot(ElementName = "nrccMessages", Namespace = "http://thalesgroup.com/RTTI/2015-11-27/ldb/types")]
    public class NrccMessages
    {
        [XmlElement(ElementName = "message", Namespace = "http://thalesgroup.com/RTTI/2012-01-13/ldb/types")]
    ...
    public class GetStationBoardResult
    {
        ...
        public NrccMessages NrccMessages { get; set; }
